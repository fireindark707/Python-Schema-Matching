...
feature_names = ["is_url","is_numeric","is_date","is_string","numeric:mean", "numeric:min", "numeric:max", "numeric:variance","numeric:cv", "numeric:unique/len(data_list)",
                ...
                "hxl_tagname:bleu_score", "hxl_attribute:jaccard"
                ]
...
if __name__ == '__main__':
    ...
    # tune parameters
    if False:
        eta_candidate = [0.1, 0.08, 0.05, 0.03]
        max_depth_candidate = [3,4,5,6,7,8,9,10]
        num_round_candidate = [100,200,300,400,500,600,700]
